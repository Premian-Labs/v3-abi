...
export interface IFeeConverterInterface extends Interface {
  getFunction(
    nameOrSignature: "convert" | "getExchangeHelper"
  ): FunctionFragment;

  getEvent(
    nameOrSignatureOrTopic: "Converted" | "SetAuthorized"
  ): EventFragment;
...
export interface IFeeConverter extends BaseContract {
  connect(runner?: ContractRunner | null): IFeeConverter;
