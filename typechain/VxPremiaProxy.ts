...
export interface VxPremiaProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "getImplementation"
...
export interface VxPremiaProxy extends BaseContract {
  connect(runner?: ContractRunner | null): VxPremiaProxy;
  waitForDeployment(): Promise<this>;

  interface: VxPremiaProxyInterface;
