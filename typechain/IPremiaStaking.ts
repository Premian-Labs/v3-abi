...
export interface IPremiaStakingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "addRewards"
...
export interface IPremiaStaking extends BaseContract {
  connect(runner?: ContractRunner | null): IPremiaStaking;
  waitForDeployment(): Promise<this>;

  interface: IPremiaStakingInterface;
