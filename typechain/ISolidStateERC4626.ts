...
export interface ISolidStateERC4626Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface ISolidStateERC4626 extends BaseContract {
  connect(runner?: ContractRunner | null): ISolidStateERC4626;
  waitForDeployment(): Promise<this>;

  interface: ISolidStateERC4626Interface;
