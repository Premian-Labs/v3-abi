...
export interface UserSettingsInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface UserSettings extends BaseContract {
  connect(runner?: ContractRunner | null): UserSettings;
