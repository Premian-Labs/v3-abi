...
export interface SolidStateERC4626Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface SolidStateERC4626 extends BaseContract {
  connect(runner?: ContractRunner | null): SolidStateERC4626;
  waitForDeployment(): Promise<this>;

  interface: SolidStateERC4626Interface;
