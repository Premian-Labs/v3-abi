...
export interface ReferralProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "getImplementation"
...
export interface ReferralProxy extends BaseContract {
  connect(runner?: ContractRunner | null): ReferralProxy;
  waitForDeployment(): Promise<this>;

  interface: ReferralProxyInterface;
