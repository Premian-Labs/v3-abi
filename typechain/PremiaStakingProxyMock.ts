...
export interface PremiaStakingProxyMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "getImplementation"
...
export interface PremiaStakingProxyMock extends BaseContract {
  connect(runner?: ContractRunner | null): PremiaStakingProxyMock;
  waitForDeployment(): Promise<this>;

  interface: PremiaStakingProxyMockInterface;
