...
export interface UniswapV3ChainlinkAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "describePricingPath"
      | "getPrice"
...
export interface UniswapV3ChainlinkAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV3ChainlinkAdapter;
  waitForDeployment(): Promise<this>;

  interface: UniswapV3ChainlinkAdapterInterface;
