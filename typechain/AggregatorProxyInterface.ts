...
export interface AggregatorProxyInterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aggregator"
      | "decimals"
...
export interface AggregatorProxyInterface extends BaseContract {
  connect(runner?: ContractRunner | null): AggregatorProxyInterface;
  ...
  ): TypedContractMethod<[phaseId: BigNumberish], [string], "view">;
  getFunction(
