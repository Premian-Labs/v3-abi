...
export interface SolidStateDiamondInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "diamondCut"
...
export interface SolidStateDiamond extends BaseContract {
  connect(runner?: ContractRunner | null): SolidStateDiamond;
  waitForDeployment(): Promise<this>;

  interface: SolidStateDiamondInterface;
