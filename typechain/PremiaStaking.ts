...
export interface PremiaStakingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PT_SEND"
...
export interface PremiaStaking extends BaseContract {
  connect(runner?: ContractRunner | null): PremiaStaking;
  waitForDeployment(): Promise<this>;

  interface: PremiaStakingInterface;
