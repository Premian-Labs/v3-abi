...
export interface ReferralMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "__trySetReferrer"
      | "claimRebate"
...
export interface ReferralMock extends BaseContract {
  connect(runner?: ContractRunner | null): ReferralMock;
  waitForDeployment(): Promise<this>;

  interface: ReferralMockInterface;
