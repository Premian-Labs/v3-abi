...
export interface UniswapV3AdapterProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "getImplementation"
...
export interface UniswapV3AdapterProxy extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV3AdapterProxy;
  waitForDeployment(): Promise<this>;

  interface: UniswapV3AdapterProxyInterface;
