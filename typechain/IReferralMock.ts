...
export interface IReferralMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "__trySetReferrer"
      | "claimRebate"
  ...
  encodeFunctionData(
    functionFragment: "__trySetReferrer",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface IReferralMock extends BaseContract {
  connect(runner?: ContractRunner | null): IReferralMock;
  waitForDeployment(): Promise<this>;

  interface: IReferralMockInterface;
  ...
  __trySetReferrer: TypedContractMethod<
    [referrer: AddressLike],
    [string],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "__trySetReferrer"
  ): TypedContractMethod<[referrer: AddressLike], [string], "nonpayable">;
  getFunction(
