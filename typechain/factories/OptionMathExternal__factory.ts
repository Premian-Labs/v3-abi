...
import type {
  OptionMathExternal,
  OptionMathExternalInterface,
} from "../OptionMathExternal";
...
export class OptionMathExternal__factory {
  static readonly abi = _abi;
  static createInterface(): OptionMathExternalInterface {
    return new Interface(_abi) as OptionMathExternalInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OptionMathExternal {
    return new Contract(address, _abi, runner) as unknown as OptionMathExternal;
  }
}
