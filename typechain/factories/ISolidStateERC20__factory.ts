...
import type {
  ISolidStateERC20,
  ISolidStateERC20Interface,
} from "../ISolidStateERC20";
...
export class ISolidStateERC20__factory {
  static readonly abi = _abi;
  static createInterface(): ISolidStateERC20Interface {
    return new Interface(_abi) as ISolidStateERC20Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISolidStateERC20 {
    return new Contract(address, _abi, runner) as unknown as ISolidStateERC20;
  }
}
