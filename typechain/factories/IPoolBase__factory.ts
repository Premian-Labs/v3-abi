...
import type { IPoolBase, IPoolBaseInterface } from "../IPoolBase";
...
export class IPoolBase__factory {
  ...
  static createInterface(): IPoolBaseInterface {
    return new Interface(_abi) as IPoolBaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IPoolBase {
    return new Contract(address, _abi, runner) as unknown as IPoolBase;
  }
}
