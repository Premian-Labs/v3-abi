...
import type { Premia, PremiaInterface } from "../Premia";
...
export class Premia__factory {
  static readonly abi = _abi;
  static createInterface(): PremiaInterface {
    return new Interface(_abi) as PremiaInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Premia {
    return new Contract(address, _abi, runner) as unknown as Premia;
  }
}
