...
import type { VxPremia, VxPremiaInterface } from "../VxPremia";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "NonblockingLzApp__CallerNotLzApp",
    type: "error",
  },
  {
    inputs: [],
    name: "NonblockingLzApp__InvalidPayload",
    type: "error",
  },
  {
    inputs: [],
    name: "NonblockingLzApp__NoStoredMessage",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "getStakePeriodMultiplierBPS",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
export class VxPremia__factory {
  static readonly abi = _abi;
  static createInterface(): VxPremiaInterface {
    return new Interface(_abi) as VxPremiaInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): VxPremia {
    return new Contract(address, _abi, runner) as unknown as VxPremia;
  }
}
