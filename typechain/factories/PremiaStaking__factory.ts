...
import type { PremiaStaking, PremiaStakingInterface } from "../PremiaStaking";
...
export class PremiaStaking__factory {
  static readonly abi = _abi;
  static createInterface(): PremiaStakingInterface {
    return new Interface(_abi) as PremiaStakingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PremiaStaking {
    return new Contract(address, _abi, runner) as unknown as PremiaStaking;
  }
}
