...
import type {
  PoolDepositWithdraw,
  PoolDepositWithdrawInterface,
} from "../PoolDepositWithdraw";
...
export class PoolDepositWithdraw__factory {
  static readonly abi = _abi;
  static createInterface(): PoolDepositWithdrawInterface {
    return new Interface(_abi) as PoolDepositWithdrawInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as PoolDepositWithdraw;
  }
}
