...
import type {
  IChainlinkAdapter,
  IChainlinkAdapterInterface,
} from "../IChainlinkAdapter";
...
export class IChainlinkAdapter__factory {
  static readonly abi = _abi;
  static createInterface(): IChainlinkAdapterInterface {
    return new Interface(_abi) as IChainlinkAdapterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IChainlinkAdapter {
    return new Contract(address, _abi, runner) as unknown as IChainlinkAdapter;
  }
}
