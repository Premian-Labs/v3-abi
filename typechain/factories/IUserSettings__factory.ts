...
import type { IUserSettings, IUserSettingsInterface } from "../IUserSettings";
...
export class IUserSettings__factory {
  static readonly abi = _abi;
  static createInterface(): IUserSettingsInterface {
    return new Interface(_abi) as IUserSettingsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IUserSettings {
    return new Contract(address, _abi, runner) as unknown as IUserSettings;
  }
}
