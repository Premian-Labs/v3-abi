...
import type { IVxPremia, IVxPremiaInterface } from "../IVxPremia";
...
export class IVxPremia__factory {
  static readonly abi = _abi;
  static createInterface(): IVxPremiaInterface {
    return new Interface(_abi) as IVxPremiaInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IVxPremia {
    return new Contract(address, _abi, runner) as unknown as IVxPremia;
  }
}
