...
export class ERC20Base__factory {
  ...
  static createInterface(): ERC20BaseInterface {
    return new Interface(_abi) as ERC20BaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC20Base {
    return new Contract(address, _abi, runner) as unknown as ERC20Base;
  }
}
