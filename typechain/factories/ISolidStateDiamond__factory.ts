...
export class ISolidStateDiamond__factory {
  static readonly abi = _abi;
  static createInterface(): ISolidStateDiamondInterface {
    return new Interface(_abi) as ISolidStateDiamondInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISolidStateDiamond {
    return new Contract(address, _abi, runner) as unknown as ISolidStateDiamond;
  }
}
