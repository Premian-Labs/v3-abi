...
import type { IPoolInternal, IPoolInternalInterface } from "../IPoolInternal";
...
export class IPoolInternal__factory {
  static readonly abi = _abi;
  static createInterface(): IPoolInternalInterface {
    return new Interface(_abi) as IPoolInternalInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPoolInternal {
    return new Contract(address, _abi, runner) as unknown as IPoolInternal;
  }
}
