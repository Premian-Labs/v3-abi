...
import type { PoolBase, PoolBaseInterface } from "../PoolBase";
...
export class PoolBase__factory {
  static readonly abi = _abi;
  static createInterface(): PoolBaseInterface {
    return new Interface(_abi) as PoolBaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PoolBase {
    return new Contract(address, _abi, runner) as unknown as PoolBase;
  }
}
