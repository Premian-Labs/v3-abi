...
import type {
  SolidStateERC4626,
  SolidStateERC4626Interface,
} from "../SolidStateERC4626";
...
export class SolidStateERC4626__factory {
  static readonly abi = _abi;
  static createInterface(): SolidStateERC4626Interface {
    return new Interface(_abi) as SolidStateERC4626Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SolidStateERC4626 {
    return new Contract(address, _abi, runner) as unknown as SolidStateERC4626;
  }
}
