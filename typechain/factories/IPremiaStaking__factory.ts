...
export class IPremiaStaking__factory {
  static readonly abi = _abi;
  static createInterface(): IPremiaStakingInterface {
    return new Interface(_abi) as IPremiaStakingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPremiaStaking {
    return new Contract(address, _abi, runner) as unknown as IPremiaStaking;
  }
}
