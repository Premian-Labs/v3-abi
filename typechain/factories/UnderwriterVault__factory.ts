...
import type {
  UnderwriterVault,
  UnderwriterVaultInterface,
} from "../UnderwriterVault";
...
export class UnderwriterVault__factory {
  static readonly abi = _abi;
  static createInterface(): UnderwriterVaultInterface {
    return new Interface(_abi) as UnderwriterVaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): UnderwriterVault {
    return new Contract(address, _abi, runner) as unknown as UnderwriterVault;
  }
}
