...
import type {
  SolidStateERC20,
  SolidStateERC20Interface,
} from "../SolidStateERC20";
...
export class SolidStateERC20__factory {
  static readonly abi = _abi;
  static createInterface(): SolidStateERC20Interface {
    return new Interface(_abi) as SolidStateERC20Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SolidStateERC20 {
    return new Contract(address, _abi, runner) as unknown as SolidStateERC20;
  }
}
