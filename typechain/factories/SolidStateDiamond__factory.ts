...
import type {
  SolidStateDiamond,
  SolidStateDiamondInterface,
} from "../SolidStateDiamond";
...
export class SolidStateDiamond__factory {
  static readonly abi = _abi;
  static createInterface(): SolidStateDiamondInterface {
    return new Interface(_abi) as SolidStateDiamondInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SolidStateDiamond {
    return new Contract(address, _abi, runner) as unknown as SolidStateDiamond;
  }
}
