...
export class ERC1155Base__factory {
  ...
  static createInterface(): ERC1155BaseInterface {
    return new Interface(_abi) as ERC1155BaseInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC1155Base {
    return new Contract(address, _abi, runner) as unknown as ERC1155Base;
  }
}
