...
import type {
  ERC1155Enumerable,
  ERC1155EnumerableInterface,
} from "../ERC1155Enumerable";
...
export class ERC1155Enumerable__factory {
  static readonly abi = _abi;
  static createInterface(): ERC1155EnumerableInterface {
    return new Interface(_abi) as ERC1155EnumerableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ERC1155Enumerable {
    return new Contract(address, _abi, runner) as unknown as ERC1155Enumerable;
  }
}
