...
export class PoolFactory__factory {
  ...
  static createInterface(): PoolFactoryInterface {
    return new Interface(_abi) as PoolFactoryInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PoolFactory {
    return new Contract(address, _abi, runner) as unknown as PoolFactory;
  }
}
