...
export interface PoolDepositWithdrawInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PoolDepositWithdraw extends BaseContract {
  connect(runner?: ContractRunner | null): PoolDepositWithdraw;
  waitForDeployment(): Promise<this>;

  interface: PoolDepositWithdrawInterface;
