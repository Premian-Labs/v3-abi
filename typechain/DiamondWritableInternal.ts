...
export interface DiamondWritableInternalInterface extends Interface {
...
export interface DiamondWritableInternal extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondWritableInternal;
  waitForDeployment(): Promise<this>;

  interface: DiamondWritableInternalInterface;
