...
export interface IERC4626BaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IERC4626Base extends BaseContract {
  connect(runner?: ContractRunner | null): IERC4626Base;
  waitForDeployment(): Promise<this>;

  interface: IERC4626BaseInterface;
