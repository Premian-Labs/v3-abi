...
export interface IDiamondReadableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "facetAddress"
      | "facetAddresses"
...
export interface IDiamondReadable extends BaseContract {
  connect(runner?: ContractRunner | null): IDiamondReadable;
  waitForDeployment(): Promise<this>;

  interface: IDiamondReadableInterface;
