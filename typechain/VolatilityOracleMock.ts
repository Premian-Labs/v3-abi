...
export interface VolatilityOracleMockInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "setVolatility",
    values: [
      AddressLike,
      BigNumberish,
      BigNumberish,
...
export interface VolatilityOracleMock extends BaseContract {
  connect(runner?: ContractRunner | null): VolatilityOracleMock;
  waitForDeployment(): Promise<this>;

  interface: VolatilityOracleMockInterface;
  ...
  findInterval: TypedContractMethod<
    [
      arr: [
        BigNumberish,
        BigNumberish,
  ...
  setVolatility: TypedContractMethod<
    [
      token: AddressLike,
      spot: BigNumberish,
      strike: BigNumberish,
