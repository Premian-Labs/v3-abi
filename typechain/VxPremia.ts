...
export interface VxPremiaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PT_SEND"
  ...
  encodeFunctionData(
    functionFragment: "resetUserVotes",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface VxPremia extends BaseContract {
  connect(runner?: ContractRunner | null): VxPremia;
  waitForDeployment(): Promise<this>;

  interface: VxPremiaInterface;
  ...
  resetUserVotes: TypedContractMethod<
    [user: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "resetUserVotes"
