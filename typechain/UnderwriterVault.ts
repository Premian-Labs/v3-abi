...
export interface UnderwriterVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface UnderwriterVault extends BaseContract {
  connect(runner?: ContractRunner | null): UnderwriterVault;
  waitForDeployment(): Promise<this>;

  interface: UnderwriterVaultInterface;
