...
cp -r ./temp/deployments/arbitrumSepolia/metadata.json ./deployment/arbitrumSepolia.json
...
echo "import arbitrumSepoliaMetadata from './arbitrumSepolia.json';" >> ./deployment/index.ts
